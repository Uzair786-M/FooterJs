...
const Footer = () => {
  <>
    ...
    >
      <div className="row">
        <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12 text-white">
          <h1
            style={{
              marginTop: "7rem",
              marginLeft: "3rem",
    ...
    <div className="col-xl-6 col-lg-12 col-md-12 col-sm-12  contactContainer">
      <div
        ...
        <div className="card-body">
          <form>
            ...
            <div className="form-group row mt-3">
              ...
              <div
                className="form-check d-flex justify-content-start mx-5 px-5"
